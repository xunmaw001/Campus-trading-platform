    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shangpinYesnoTypes" label="商品审核" prop="shangpinYesnoTypes">
                        <el-input v-model="ruleForm.shangpinYesnoValue" placeholder="商品审核" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shangpinYesnoText" label="审核结果" prop="shangpinYesnoText">
                        <span v-html="ruleForm.shangpinYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="24">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    shangpinYesnoTypes: false,
                    shangpinYesnoText: false,
                    shangxiaTypes: false,
                ...
                rules: {
                   ...
                   shangpinYesnoTypes: [
                              { required: true, message: '商品审核不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangpin_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangpinYesnoTypesOptions = data.data.list;
                    }
                });
                this.$http({
