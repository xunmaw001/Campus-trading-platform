<template>
    <div class="main-content">
        <el-dialog title="审核" :visible.sync="shangpinYesnoTypesVisible">
            <el-form :model="form">
                <input type="hidden" v-model="form.id">
                <el-form-item label="审核" >
                    <el-select v-model="form.shangpinYesnoTypes" placeholder="请选择商品审核">
                        <el-option label="已通过" value="2"></el-option>
                        <el-option label="已拒绝" value="3"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="审核结果">
                    <el-input type="textarea" v-model="form.shangpinYesnoText" placeholder="审核结果"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button @click="shangpinYesnoTypesVisible = false">取 消</el-button>
                <el-button type="primary" @click="shangpinYesnoTypesShenhe">审 核</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanjiaoyipingtai/upload/shangpinMuBan.xls"
                        >批量导入商品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="shangpinYesnoTypes"
                                      header-align="center"
                                      label="商品审核">
                        <template slot-scope="scope">
                            {{scope.row.shangpinYesnoValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="shangpinYesnoText"
                                      header-align="center"
                                      label="审核结果">
                        <template slot-scope="scope">
                            <span v-if="scope.row.shangpinYesnoText != null &&scope.row.shangpinYesnoText.length>10">
                                {{scope.row.shangpinYesnoText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.shangpinYesnoText}}
                            </span>
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangpin','审核') && scope.row.shangpinYesnoTypes == 1 " type="primary" icon="el-icon-thumb" size="mini" @click="openYesnoTypes(scope.row.id)">审核</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                shangpinYesnoTypes : null,
                shangpinYesnoText : null,
                shangxiaTypes : null,
                shangpinDelete : null,
            ...
            shangpinYesnoTypesVisible : false,
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '商品审核': "shangpinYesnoTypes",
                     '审核结果': "shangpinYesnoText",
                     '是否上架': "shangxiaTypes",
            },
        ...
        methods: {
			...
			shangxia(id,shangxiaTypes){
                ...
                _this.form.id = null;
                _this.form.id = id;
                            _this.form.shangpinYesnoText = null;
                _this.form.shangpinYesnoTypes = "请选择商品审核";
                _this.shangpinYesnoTypesVisible = true;
            },

            shangpinYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.shangpinYesnoTypes == "请选择商品审核"){
                    _this.$message.error("请选择商品审核");
                    return false;
                }
                if(_this.form.shangpinYesnoText == null || _this.form.shangpinYesnoText == ""){
                ...
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        this.$message({
                            ...
                            duration: 1500,
                            onClose: () => {
                                _this.shangpinYesnoTypesVisible = false;
                                _this.search();
                            }
                        });
                    } else {
