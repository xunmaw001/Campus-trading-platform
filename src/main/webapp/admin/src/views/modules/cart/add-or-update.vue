    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品审核" prop="shangpinYesnoValue">
                        <el-input v-model="shangpinForm.shangpinYesnoValue"
                                  placeholder="商品审核" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品审核" prop="shangpinYesnoValue">
                            <el-input v-model="ruleForm.shangpinYesnoValue"
                                      placeholder="商品审核" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="审核结果" prop="shangpinYesnoText">
                        <el-input v-model="shangpinForm.shangpinYesnoText"
                                  placeholder="审核结果" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="审核结果" prop="shangpinYesnoText">
                            <el-input v-model="ruleForm.shangpinYesnoText"
